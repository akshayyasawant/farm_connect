    ...
    useEffect(() => {
        const fetchFarmerDetails = async () => {
            try {
                ...
                console.log('Fetching farmer details with token:', token.substring(0, 10) + '...');
                ...
                if (!response.ok) {
                    ...
                    throw new Error(responseData.message || 'Failed to fetch farmer details');
                }

                setFarmer(responseData);
            } catch (err) {
